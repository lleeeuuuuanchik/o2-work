...
o2.gRangeSlider = {
  init: function init() {
    $('._range-trigger').each(function (index, element) {
      ...
      var sliderLabels = $(element).siblings('.g-range-slider-labels');

      if (sliderLabels.length) {
        var labelFrom = sliderLabels.find('.g-range-slider-labels_from');
        var labelTo = sliderLabels.find('.g-range-slider-labels_to');
...
o2.gSelect = {
  selectState: {
    ...
    */
    selectDropdownToggle: function selectDropdownToggle() {
      if (!this.isOpen) {
        this.clickOutsideListener = o2.clickOutside($('.g-select'), function () {
    ...
    */
    markSelectedItem: function markSelectedItem(instance) {
      $('.g-select-list__item').each(function (index, element) {
...
o2.gTabs = {
  open: function open(instance, tabId) {
    ...
    var openedTab = $(tabsContainer).find('.g-tab[data-tab-id="' + tabId + '"]');
    var tab = $(tabsContainer).find('.g-tab');
    if ($(openedTab).hasClass('g-tab_open')) return false;
    $(tabsContainer).find('.g-tab.g-tab_open').fadeOut(200, function () {
  ...
  markActiveTab: function markActiveTab(activeItem) {
    var tabItems = $(activeItem).parents('._tabs-container').find('.g-tabs__item');
    $(tabItems).each(function (index, item) {
      if ($(item).hasClass('g-tabs__item_active')) $(item).removeClass('g-tabs__item_active');
